...
Appendix~\ref{appendix:B3}; see \eqref{eq:B31}. Explicitly,
\begin{equation}
\mathbb{E}[x_{t,T}]
=
...
\textbf{Goal.}
Show that, in the baseline identified case,
\begin{equation}
\mathbb{E}\left[x_{t,T}\right]
=
x_{t_0,t_0}e^{-a^2\left(T+t-2t_0\right)}
+
x_\infty
-
x_\infty e^{-a^2\left(T-t_0\right)}.
\tag{B.3.1}\label{eq:B31}
\end{equation}

\medskip
\noindent\textbf{Step 1: Start from equation \((2.3.7)\).}
We have
\[
\frac{\partial \mathbb{E}\left[x_{t,T}\right]}{\partial t}
=
-a^2
\left[
...
\medskip
\noindent\textbf{Step 2: Integrate with respect to time.}
Integrating from \(t_0\) to \(t\) gives
\[
\int_{t_0}^{t}\frac{\partial \mathbb{E}\left[x_{s,T}\right]}{\partial s}\,ds
=
-a^2 e^{-a^2(T-t_0)}
\int_{t_0}^{t}
\left[
...
Hence
\[
\mathbb{E}\left[x_{t,T}\right]-x_{t_0,T}
=
-a^2 e^{-a^2(T-t_0)}
\int_{t_0}^{t}
\left[
...
e^{-a^2(T-t_0)}
\left[
\left(x_{t_0,t_0}-\frac{x_\infty}{2}\right)\left(e^{-a^2(t-t_0)}-1\right)
+
\frac{x_\infty}{2}\left(e^{-a^2(t-t_0)}-1\right)
\right].
\]
Collecting terms,
\[
...
\medskip
\noindent\textbf{Step 4: Substitute for \(x_{t_0,T}\).}
Using
\[
x_{t_0,T}
=
...
\mathbb{E}\left[x_{t,T}\right]
&=
(x_{t_0,t_0}-x_\infty)e^{-a^2(T-t_0)}
+x_\infty
+x_{t_0,t_0}e^{-a^2(T-t_0)}\left(e^{-a^2(t-t_0)}-1\right)
\nonumber\\
&=
x_\infty
-
x_\infty e^{-a^2(T-t_0)}
+
x_{t_0,t_0}e^{-a^2(T-t_0)}e^{-a^2(t-t_0)}
\nonumber\\
&=
x_{t_0,t_0}e^{-a^2\left(T+t-2t_0\right)}
+x_\infty
